...
def read_database():
    file = open("C:/Users/mimik/OneDrive/Desktop/PythonFiles/contacts.txt", mode="r", encoding="utf-8")
    rows = []
    for row in file:
...
def write_database(db):
    file = open("C:/Users/mimik/OneDrive/Desktop/PythonFiles/contacts.txt", mode="w", encoding="utf-8")
    rows = []
    for row in db:
...
def print_out_commands(db):
    ...
    if command == "1":
        ...
        user = (f"\n{name}, {phone}, {age}, {mail}")
        file = open("C:/Users/mimik/OneDrive/Desktop/PythonFiles/contacts.txt", "a")
        file.write(user)
        file.close()
